	...
	return (
		<div className="w-11/12 mt-20 flex justify-center items-center">
			<div className="animate__animated animate__fadeInDown w-11/12 md:w-1/3 mb-4 flex flex-col">
				...
				>
					<FcGoogle className="w-6 h-auto mr-2" /> Google Login{" "}
				</a>
				<a
				...
				>
					<FaFacebookSquare className="w-6 h-auto mr-2" /> Facebook Login{" "}
				</a>
				<p className="self-center text-center">You don't have an account yet?</p>
				<Link to="/signup" className="self-center text-center text-emerald-400">
					Sign Up Here!
				</Link>
			</div>
